...
runApp.$inject = ['$rootScope', '$state', 'editableOptions', 'HLMessages', 'HLSockets', 'Tenant', 'UserTeams'];
function runApp($rootScope, $state, editableOptions, HLMessages, HLSockets, Tenant, UserTeams) {
